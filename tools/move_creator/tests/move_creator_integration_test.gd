...
func _initialize()->void:
	...
	assert(creator.export_dialog!=null and creator.export_dialog.file_mode==FileDialog.FILE_MODE_SAVE_FILE and creator.export_dialog.current_file.ends_with(".csv"),"Move Creator must provide a configured CSV export save dialog.")
